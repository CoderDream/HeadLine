...
//  News
//
//  Created by CoderDream on 2019/5/16.
...
//    var descriptionHeight: CGFloat? { return Calculate.textHeight(text: description, fontSize: 13, width: screenWidth - 30.0) }
    var descriptionHeight: CGFloat? { return description.boundingRect(with: CGSize(width: SCREEN_WIDTH - 30.0, height: CGFloat(MAXFLOAT)), options: .usesLineFragmentOrigin, attributes: [.font: UIFont.systemFont(ofSize: 13)], context: nil).size.height + 5.0}
...
//
    ...
    //var group = DongtaiOriginGroup()// TODO
...
struct DongtaiComment: HandyJSON {
    ...
    var user_bury: Int = 0
    var create_time: TimeInterval = 0
    //var createTime: String? { return create_time.convertString() }// TODO
...
struct UserDetailAnswer: HandyJSON {
    ...
    var browCount: String? {
        //return brow_count.convertString()
        guard brow_count >= 10000 else {
            return String(describing: brow_count)
        }
        return String(format: "%.1f万", Float(brow_count) / 10000.0)
    }
    var ansid: String = ""
